...
ubuntu:
	make destroy create prepare verify MOLECULE_KVM_IMAGE=${UBUNTU_KVM_IMAGE} MOLECULE_SCENARIO=${MOLECULE_SCENARIO}
...
debian:
	make destroy create prepare verify MOLECULE_KVM_IMAGE=${DEBIAN_KVM_IMAGE} MOLECULE_SCENARIO=${MOLECULE_SCENARIO}

bookworm debian12:
	make debian MOLECULE_SCENARIO=${MOLECULE_SCENARIO} DEBIAN_RELEASE=bookworm

alma:
	make destroy create prepare verify MOLECULE_KVM_IMAGE=${ALMA_KVM_IMAGE} MOLECULE_SCENARIO=${MOLECULE_SCENARIO}
...
rocky:
	make destroy create prepare verify MOLECULE_KVM_IMAGE=${ROCKY_KVM_IMAGE} MOLECULE_SCENARIO=${MOLECULE_SCENARIO}
